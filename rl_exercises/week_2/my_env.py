...
class MyEnv(gym.Env):
    ...
    def __init__(
        self,
        transition_probabilities: np.ndarray = np.ones((25, 4)),
        rewards: list[float] = [
            -10,
            0,
            0,
        ...
        transition_probabilities : np.ndarray, optional
            A (num_states, 4) array specifying the probability of actions being followed.
        rewards : list of float, optional
            Rewards assigned to each position.
        ...
        self.position = 2  # start at upper left
    ...
    def step(
        ...
        ----------
        action : int
            Action to take (0: left, 1: right, 2: up, 3: down).
